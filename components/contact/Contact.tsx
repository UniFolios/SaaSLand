      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            {/* Contact Cards */}
            <div className="bg-white text-black p-6 rounded-lg flex justify-between items-start">
              <div>
                <p className="text-sm mb-1">Call Us:</p>
                <p className="text-xl font-medium">+01 598 269 4756</p>
              </div>
            </div>
            ...
            <div className="bg-white text-black p-6 rounded-lg flex justify-between items-start">
              <div>
                ...
                <p className="text-xl font-medium">info@example.com</p>
              </div>
            </div>

            <div className="bg-white text-black p-6 rounded-lg flex justify-between items-start">
              <div>
                <p className="text-sm mb-1">Visit Us:</p>
                <p className="text-xl font-medium">123 Business Street, NY</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border rounded-sm focus:ring-2 focus:ring-black focus:border-black ${
              ...
              {submitSuccess && (
                <div className="p-3 bg-green-100 text-green-700 rounded-sm">
